...
// First slot was originally #B5442E (brick red) — replaced with an
// indigo, since brick red sat only ~4° of hue from C.error and ~9° from
// Rust's mood-ramp color (96152ba), making a goal tag nearly
// indistinguishable from an error state or a Rust-theme mood dot.
// Slots 2/3/4/5 are pending a live visual-iteration pass (backlog #5) —
// not touched here.
export const GOAL_COLORS = ["#4E4F9E", "#3E7A57", "#3A5A8C", "#8A5A9E", "#B8862E"];
