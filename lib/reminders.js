...
// Exported -- Day Dots (app/(tabs)/feed.js) reuses the exact same
// cutoff the real evening reminder fires at for its grey/active
// check, not a second independently-maintained copy of the hour/minute
// that could drift out of sync with this file's own scheduleDailyReminder.
...
// Day Dots -- lives on the My Day filtered view (see app/(tabs)/feed.js),
// not tied to the daily_reminder toggle. EVENING_HOUR/EVENING_MINUTE
// above are reused there as a plain "is it past this local time today"
// check (grey-out vs. active), no separate window/timer machinery here.
